...
| Q12 | Most improved home/away goal differential | CTE + `UNION ALL` + aggregation + `LAG()` + join | VVV-Venlo's home/away GD gap shrank from +44 (2011/2012) to -11 (2012/2013), driven by improved away form (-40 → -9) more than home form decline (+4 → -20) |
